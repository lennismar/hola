	...
	<section class="wrapper">
		...
		<div class="page-container-fixed-pad">
			...
			<div  class="col-pad col-pad--half contact-form" id="main">
				...
				<div class="contact-gracias-tittle">Gracias por contactar con Sormrurals.</div>
				
				<p> En breve nos pondremos en contacto contigo para solucionar tus posibles dudas.</p>
