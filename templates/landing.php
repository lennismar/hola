			...
			<div class="hero-container hero-container--semiblack">
				...
				<div class="hero-inner">
					...
					<div class="hero-inner-buttons">
						...
						<a href="#favoritas" class="btn-smooth-scroll"><span class="icon icon--love-white">Nuestras casas favoritas</span></a>
						
						<a href="#quever" class="btn-smooth-scroll"><span class="icon icon--quever-white">Qué ver</span></a>
			...
			<article class="col-pad col-pad--three-fourth">
				...
				<div class="search-info clearfix">
					...
					<div class="search-results-map">
						<a href="#" class="icon icon--map" data-type="iframe">Mapa</a>
					</div>
