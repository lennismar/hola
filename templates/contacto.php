...
$().ready(function() {
	...
	$("#ContactForm").validate({
		...
		messages: {
			...
			telefono: {
				required: "Introduzce tu telefono",
	...
	<section class="wrapper">
		...
		<div class="page-container-fixed-pad">
			...
			<div  class="col-pad col-pad--half contact-form" id="main">
					...
					<form action="contacto-gracias.php" method="post" id="ContactForm" name="ContactForm">
						...
						<div class="label-group clearfix">
							...
							<div class="label-group">
								...
								<select id="motivo" name="motivo" required>
									<option value="" disabled selected style="display:none; color:#777" >Selecciona una opción</option>
									<option value="m1">Consulta sobre una casa rural</option>
									<option value="m2">Consulta sobre pagos</option>
									<option value="m3">Consulta sobre alta de casa rural</option>
									<option value="m4">Otros</option>
								</select>
							</div>
						...
						<div class="label-group motivo" id="m1" style="display:none">
							...
							<label>Referencia de la casa rural</label>

							<input type="text" placeholder="" class="" name="referencia" id="referencia" required>

							<div class="explanatory-text">La encontrarás en la ficha de la casa rural</div>
