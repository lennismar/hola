...
<div class="container-main" id="container">
	...
	<div class="wrapper">
		...
		<div class="hero--small hero-custom-template">
		
			<div class="hero-container">
		
				<div class="hero-inner--small">
			
					<h1 class="h1-header">Política de Cookies</h1>
	...
	<section class="wrapper">
		...
		<div class="page-container-fixed-pad">
			...
			<article class="col-pad col-pad--two-third content-custom-template">
						
				<h3>¿Qué son las cookies?</h3><p>Una cookie es un fichero que se descarga en tu ordenador o terminal al acceder a nuestra página web. Las cookies nos permiten, entre otras cosas, almacenar y recuperar información sobre los hábitos de navegación de un usuario o de su equipo y, dependiendo de la información que contengan y de la forma en que utilice su equipo, pueden utilizarse para reconocer al usuario.</p><h3>¿Que tipo de cookies usa esta web?</h3><p>Nuestra página utiliza cookies de Google Analytics para medir la interacción del usuario con la página web. Esta Cookie está desarrollada por Google y nos permite conocer qué hace un usuario en nuestra web y mejorarla en consecuencia.</p><h3>Administración de la Cookie</h3><p>Puedes permitir, bloquear o eliminar las cookies instaladas en tu ordenador mediante la configuración de las opciones del navegador instalado en tu ordenador.</p><p>Más información sobre el navegador <a href="http://support.mozilla.org/es/kb/cookies-informacion-que-los-sitios-web-guardan-en-" target="_blank" rel="nofollow">Firefox</a></p><p>Más información sobre el navegador <a href="https://support.google.com/chrome/answer/95647?hl=es" target="_blank" rel="nofollow">Chrome</a></p><p>Más información sobre el navegador <a href="http://windows.microsoft.com/en-us/internet-explorer/delete-manage-cookies#ie=ie-11" target="_blank" rel="nofollow">Explorer</a></p><p>Más información sobre el navegador <a href="http://support.apple.com/kb/HT1677?viewlocale=es_ES&amp;locale=es_ES" target="_blank" rel="nofollow">Safari</a></p><p>Más información sobre el navegador <a href="http://help.opera.com/Linux/10.60/es-ES/cookies.html" target="_blank" rel="nofollow">Opera</a></p>
					
					<h3>Política de Privacidad</h3><p>Nuestra política de privacidad describe como recogemos, guardamos o utilizamos la información que recabamos a través de los diferentes servicios o páginas disponibles en este sitio. Es importante que entienda que información recogemos y cómo la utilizamos ya que el acceso a este sitio implica la aceptación nuestra política de privacidad.</p><p>COOKIES</p><p>El acceso a este puede implicar la utilización de cookies. Las cookies son pequeñas cantidades de información que se almacenan en el navegador utilizado por cada usuario para que el servidor recuerde cierta información que posteriormente pueda utilizar. Esta información permite identificarle a usted como un usuario concreto y permite guardar sus preferencias personales, así como información técnica como puedan ser visitas o páginas concretas que visite. Aquellos usuarios que no deseen recibir cookies o quieran ser informados antes de que se almacenen en su ordenador, pueden configurar su navegador a tal efecto.</p><p>La mayor parte de los navegadores de hoy en día permiten la gestión de las cookies de 3 formas diferentes:</p><p>1. Las cookies no se aceptan nunca.<br /> 2. El navegador pregunta al usuario si se debe aceptar cada cookie.<br /> 3. Las cookies se aceptan siempre.</p><p>El navegador también puede incluir la posibilidad de especificar mejor qué cookies tienen que ser aceptadas y cuáles no. En concreto, el usuario puede normalmente aceptar alguna de las siguientes opciones: rechazar las cookies de determinados dominios; rechazar las cookies de terceros; aceptar cookies como no persistentes (se eliminan cuando el navegador se cierra); permitir al servidor crear cookies para un dominio diferente. Además, los navegadores pueden también permitir a los usuarios ver y borrar cookies individualmente.</p><p>Google, como proveedor asociado, utiliza cookies para publicar anuncios en su sitio. Los usuarios pueden inhabilitar el uso de la cookie de DART a través del anuncio de Google y accediendo a la política de privacidad de la red de contenido.</p><p>Dispone de más información sobre las Cookies en: <a href="http://es.wikipedia.org/wiki/Cookie" target="_blank" rel="nofollow">http://es.wikipedia.org/wiki/Cookie</a></p><p>Este sitio mide el tráfico con diferentes soluciones que pueden utilizar cookies para analizar lo que sucede en nuestras páginas. Actualmente utilizamos las siguientes soluciones para la medición del tráfico de este sitio. Puede ver más información sobre la política de privacidad de cada una de las soluciones utilizadas para tal efecto:</p><p>Google (Analytics): <a href="http://www.google.com/intl/es_ALL/privacypolicy.html" target="_blank" rel="nofollow">http://www.google.com/intl/es_ALL/privacypolicy.html</a></p>

			</article>
			
			<aside  class="col-pad col-pad--third only-desktop">
			
				<p>Estaremos encantados de atenderte ya sea para solucionar tus dudas, informarte sobre nuestras casas rurales o atender cualquier consultar relacionada con tu reserva.</p>
				
				<div class="contact-email"><a href="mailto:<?php echo ADMIN_BCC ?>" class="icon icon--email-orange"><?php echo ADMIN_BCC ?></a></div>
				
				<p>Te daremos la respuesta más rápida posible.Si lo deseas, también puedes visitar nuestro apartado de Preguntas frecuentes para más aclaraciones.</p>
				
				<hr class="hr-line-1">
				
				<p class="h6-header">EN REDES SOCIALES</p>
