		...
		<div class="page-container-fixed-pad">
			...
			<article  class="col-pad col-pad--two-third" id="main">
				...
				<div class="clearfix checkout-form-process">
					...
					<form action="checkout-2.php" method="post" id="CheckOutForm" name="CheckOutForm">
						...
						<div class="label-group pay-way">
							...
							<select id="forma-de-pago">
								<option value="forma-de-pago1">Transferencia Bancaria</option>
						...
						<div class="label-group check-out-advice forma-de-pago" id="forma-de-pago2">
							...
							<ol>
								...
								<li>Una vez confirmada, te enviaremos un <strong>email</strong> con un link a nuestra web para que realices el <strong>pago del importe anticipado</strong> mediante <strong>tarjeta de crédito</strong>.</li>
						...
						<div class="label-group">No incluye la tasa turística de 0´50 € por persona y día.</div>
			...
			<aside class="col-special-one-third">
