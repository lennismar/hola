	...
	<div id="wrapper">		
		...
		<div id="main_container" class="main_container container_16 clearfix">
			<div class="flat_area grid_16">
				<h2>Reserves</h2>
                <p><button class="button_colour orange round_all" onClick="location.href='reservations_all.php'"><span>Veure totes</span></button></p>
			</div>
...
<?php
	...
	if($filter!=""){
		...
		$limit = null;
	} else $limit = 50; /* Si no estoy filtrando por nada, solo muestro las ultimas 50 rservas, para agilizar la carga de pantalla*/
	$rs_query=$db->get('reservations',$limit,'resid, eid, resdate, checkin, checkout, numdays, totalprice, persons, restid, ofirstname, olastname, oemail, rescode, paid, feeamount');
