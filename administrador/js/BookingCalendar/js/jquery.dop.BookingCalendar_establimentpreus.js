...
(function($)
{
    $.fn.DOPBookingCalendar = function(options)
    {
        var Data = {'Type':'BackEnd',
                    'DataURL':'js/BookingCalendar/php/load_establimentpreus.php',
                    'SaveURL':'js/BookingCalendar/php/save_establimentpreus.php',
                    ...
                    'UnavailableText':'SENSE DISPONIBILITAT', // The unavailable text.
                    'DateType':2, // 1: american style; 2: european style;
                    'PopupDisplayTime':300, // The time for the Pop-Up to Show/Hide
                    'StatusLabel':'Disponibilitat', // The text for Availability label.
                    'PriceLabel':'Preu', // The text for Price label.
                    'Currency':'€', // The currency.
                    'SubmitBtnText':'Acceptar', // The text for Submit button.
        ...
        methods = {
                    ...
                    initBackendBookingCalendar:function(){// Init Backend Calendar
                        ...
                        HTML.push('               <option value="0">No Disponible</option>');
                        HTML.push('               <option value="1">Disponible</option>');				
                        HTML.push('           </select>');
