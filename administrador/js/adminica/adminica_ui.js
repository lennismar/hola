...
//jQuery UI elements (more info can be found at http://jqueryui.com/demos/)
	...
	// Input Datepicker Config
		$( ".datepicker" ).datepicker({ dateFormat: 'yy-m-d' }); // the time format which will be input to the datepicker field upon selection. more info on formatting here: http://docs.jquery.com/UI/Datepicker/formatDate
