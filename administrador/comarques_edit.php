...
<?php
if(isset($id)){
	/*$rs_query = mysqli_query("SELECT comid, title, description_es, description_ca, description_en, description_fr,headimage1,headimage2,headimage3 FROM comarques WHERE comid = " . $id);
	$rs = mysqli_fetch_array($rs_query);*/
    $db->where('comid',$id);
    $rs=$db->getOne('comarques','comid, title, description_es, description_ca, description_en, description_fr,headimage1,headimage2,headimage3');		
	...
	?><h2>Editar Comarca - <?php echo $title; ?></h2><?php				
}
?>                
				</div>
				...
				<div class="box grid_16">
					<div class="toggle_container">
						<div class="block no_padding">
							<ul class="full_width">
                            	<div class="block">
                                    <form id="comarques_form" action="comarques_act.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php if($headimage1!=""){ ?>
                                        <br />
                                        <img src="<?php echo URL_BASE . FILE_DIR . "comarcas/" . $headimage1;?>" width="350" vspace="5" hspace="5" align="absmiddle"><br />
                                        <?php echo $headimage1; ?>	
                                        ...
                                        <?php if($headimage2!=""){ ?>
                                        <br />
                                        <img src="<?php echo URL_BASE . FILE_DIR . "comarcas/" . $headimage2;?>" width="350" vspace="5" hspace="5" align="absmiddle"><br />
                                        <?php echo $headimage2; ?>	
                                        <!--<input type="checkbox" name="image_del" value="1">&nbsp;Esborrar-->
                                        <?php } ?>
                                        ...
                                        <?php if($headimage3!=""){ ?>
                                        <br />
                                        <img src="<?php echo URL_BASE . FILE_DIR . "comarcas/" . $headimage3;?>" width="350" vspace="5" hspace="5" align="absmiddle"><br />
                                        <?php echo $headimage3; ?>	
                                        <!--<input type="checkbox" name="image_del" value="1">&nbsp;Esborrar-->
                                        <?php } ?>
				...
				<div class="flat_area grid_16">
                    <p style="display:inline">
                        <button class="button_colour orange round_all" style="clear:none" onClick="javascript:window.location = 'comarques.php';"><img width="24" height="24" alt="Tornar" src="images/icons/small/white/bended_arrow_left.png"><span>Tornar</span></button>
                        <button class="button_colour orange round_all" style="clear:none" onClick="javascript:forms.comarques_form.submit();"><img width="24" height="24" alt="Guardar" src="images/icons/small/white/box_incoming.png"><span>Guardar</span></button>
                    </p>
				</div>                
			</div>
		</div>
