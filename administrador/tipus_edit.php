...
<?php
if(isset($id)){
	/*$rs_query = mysqli_query("SELECT tid, title_es, title_ca, title_en, title_fr FROM tipus WHERE tid = " . $id);
	$rs = mysqli_fetch_array($rs_query);*/
	$db->where('tid',$id);
	$rs=$db->getOne('tipus','tid, title_es, title_ca, title_en, title_fr');
	...
	?><h2>Editar Tipus d'allotjament</h2><?php				
...
?>                
				...
				<div class="box grid_16">
					<div class="toggle_container">
						<div class="block no_padding">
							<ul class="full_width">
                            	<div class="block">
                                    <form id="tipus_form" action="tipus_act.php" method="post">
				...
				<div class="flat_area grid_16">
                    <p style="display:inline">
                        <button class="button_colour orange round_all" style="clear:none" onClick="javascript:window.location = 'tipus.php';"><img width="24" height="24" alt="Tornar" src="images/icons/small/white/bended_arrow_left.png"><span>Tornar</span></button>
