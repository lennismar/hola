<div id="template_options" class="clearfix">
	...
	<div class="layout_position round_all">
		<label>Theme: </label>
		<a href="css/theme/switcher5.php?style=switcher.css">Dark</a><span>|</span>
		<a href="css/theme/switcher5.php?style=theme_light.css">Light</a>
	</div>
	...
	<div class="theme_background round_all">
		<label>Light BGs:</label>
		<a href="css/theme/switcher4.php?style=switcher.css">Silver</a><span>|</span>
		<a href="css/theme/switcher4.php?style=bg_white_wood.css">Wood</a><span>|</span>
		<a href="css/theme/switcher4.php?style=bg_squares.css">Squares</a><span>|</span>
		<a href="css/theme/switcher4.php?style=bg_noise_zero.css">Noise</a><span>|</span>
		<a href="css/theme/switcher4.php?style=bg_stripes.css">Stripes</a>
	</div>
	</div>
</div>
