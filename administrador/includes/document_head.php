...
<html>
	<head>
		...
		<title>Som Rurals | Administrador</title>
        ...
        <link rel="stylesheet" type="text/css" href="js/BookingCalendar/css/jquery.dop.BookingCalendar.css" />
		...
		<script language="javascript">
			$(document).ready(function(){
			   ...
			   $("#pvid").change(function () {
					$("#pvid option:selected").each(function () {
						//alert($(this).val());
							elegido=$(this).val();
							$.post("inc_comarques.php", { elegido: elegido }, function(data){
							$("#comid").html(data);
						});			
					});
			   })
		...
		<script type="text/javascript" src="js/plupload/js/i18n/ca.js"></script>
