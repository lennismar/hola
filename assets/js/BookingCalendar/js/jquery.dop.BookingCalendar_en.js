...
(function($)
{
    $.fn.DOPBookingCalendar = function(options)
    {
        var Data = {'Type':'BackEnd',
                    ...
                    'BookedText':'Unavailable', // The Booked text.
                    'UnavailableText':'Unavailable', // The unavailable text.
                    'DateType':2, // 1: american style; 2: european style;
                    'PopupDisplayTime':300, // The time for the Pop-Up to Show/Hide
                    'StatusLabel':'availability', // The text for Availability label.
                    'PriceLabel':'Price', // The text for Price label.
                    'Currency':'€', // The currency.
                    'SubmitBtnText':'Accept', // The text for Submit button.
