...
function beforeShowDayFrom(date) {
    var ymd = jQuery.datepicker.formatDate('yy-mm-dd', date);
    var reservacion = _.find(detalle_de_reservaciones, { 'checkout': ymd });
...
function beforeShowDayTo(date) {
    var ymd = jQuery.datepicker.formatDate('yy-mm-dd', date);
    var reservacion = _.find(detalle_de_reservaciones, { 'checkin': ymd });
...
$(document).ready(function() {
    ...
    $(function() {
        ...
        $("#BookForm #from").datepicker({
            ...
            firstDay: 1,
            minDate: new Date(),
            beforeShowDay: beforeShowDayFrom,
            defaultDate: +1,
            onClose: function(selectedDate) {
