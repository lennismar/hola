...
$meta_title="Som Rurals ".HEADER_TITLE.". ".PREGUNTAS_FRECUENTES;
$meta_description=PREGUNTAS_FRECUENTES_SEO_DESCRIPCION;
		...
		<div class="hero--small hero-custom-template">
			...
			<div class="hero-container">
				...
				<div class="hero-inner--small">
					...
					<h1 class="h1-header"><?php echo PREGUNTAS_FRECUENTES; ?></h1>
	...
	<section class="wrapper">
		...
		<div class="page-container-fixed-pad">
			...
			<article class="col-pad col-pad--two-third content-custom-template">
				<?php echo PREGUNTAS_FRECUENTES_CONTENT; ?>  
			</article>
