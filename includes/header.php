	...
	<div class="page-container-fixed">
			...
			<ul class="nav">
	            ...
	            <li>
	            	<form class="search_header" method="post" action="search.php">
					    <input id="search-box dicon-input-search--right" type="text" name="buscador" placeholder="<?php echo NOMBRE_REFERENCIA; ?>">
					</form>
	            </li>
	            ...
	            <li>
					...
					<div id="dd" class="wrapper-dropdown-3" tabindex="1">
						...
						?>
                        <ul class="dropdown">
							<li onclick="location.href = '<?php echo URL_BASE; ?>es/';"><a href="/es/"><span class="icon icon--flag-es">Castellano</span></a></li>
							<li onclick="location.href = '<?php echo URL_BASE; ?>ca/';"><a href="/ca/"><span class="icon icon--flag-cat">Català</span></a></li>
							<li onclick="location.href = '<?php echo URL_BASE; ?>en/';"><a href="/en/"><span class="icon icon--flag-en">English</span></a></li>
							<li onclick="location.href = '<?php echo URL_BASE; ?>fr/';"><a href="/fr/"><span class="icon icon--flag-fr">Français</span></a></li>
						</ul>
					</div>
	            </li>
			</ul>
		...
		<a href="javascript:hideshow(document.getElementById('menu'))" class="menu-trigger" id="btn-show-menu">
			<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="45px" height="45px" viewBox="0 0 45 45" enable-background="new 0 0 45 45" xml:space="preserve">
				<rect x="10" y="12" fill="#ABABAB" width="25" height="3"/>
				<rect x="10" y="20" fill="#ABABAB" width="25" height="3"/>
				<rect x="10" y="28" fill="#ABABAB" width="25" height="3"/>
			</svg>
		</a>
