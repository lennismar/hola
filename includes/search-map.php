...
<script>
	function initialize() {
		...
		var contentString = '<div id="content-map-pin">'+
							...
							'<img src="'+cdn_base+'assets/img/foto-casa.jpg" alt="foto-casa" width="739" height="397" />'+
							'</div>'+
							...
							'</div>'+
							'<a href="#" class="card-btn"><?php echo VER_CASA; ?></a>'+
							'</div>';
		...
		var marker = new google.maps.Marker({
			...
			icon: cdn_base+'assets/img/icon-point-map.svg'
		});
