		...
		<div class="page-container-fixed-pad">
			...
			<div class="row">
				...
				<div class="list-col-four">
					...
					<div class="footer-title"><?php echo SIGUENOS; ?></div>
				...
				<div class="list-col-four">
					...
					<div class="footer-title"><?php echo SOBRE_NOSOTROS; ?></div>
					...
					<ul class="block-list">
						...
						<li><a href="<?php echo $lng."/".URL_PREGUNTAS_FRECUENTES;?>"><?php echo PREGUNTAS_FRECUENTES; ?></a></li>
						<li><a href="<?php echo $lng."/".URL_TERMINOS_CONDICIONES;?>"><?php echo TERMINOS_CONDICIONES_GENERALES; ?></a></li>
						<li><a href="<?php echo CDN_BASE; ?>assets/media/text-legal.pdf" target="_blank">Legal</a></li>
						<li><a href="cookies.php"><?php echo COOKIES; ?></a></li>
					</ul>
				...
				<div class="list-col-four">
					...
					<div class="footer-title"><?php echo PROPIETARIOS; ?></div>
					
					<ul class="block-list">
						<li><a href="<?php echo $lng."/".URL_CASA_NUEVA;?>"><?php echo AÑADE_CASA; ?></a></li>
						<li><a href="administrador/"><?php echo ACCESO; ?></a></li>
					</ul>
				    &nbsp;
					...
					<ul class="block-list">
						<li><a href="http://www.eresrural.com">Eresrural</a></li>
					</ul>
				...
				<div class="list-col-four">
					...
					<?php echo TODOS_IVA; ?>
					<img src="<?php echo CDN_BASE; ?>assets/img/payment-footer.png" class="push-half--top" alt="Forma de pago" width="241" height="78" />
                    <!-- Begin DigiCert site seal HTML and JavaScript -->
                    <div id="DigiCertClickID_VrqPJ2Cs" data-language="es">
                        <a href="http://www.digicert.com/" style="color: #777;">SSL Certificate</a>
                    </div>
                    <script type="text/javascript">
                        var __dcid = __dcid || [];__dcid.push(["DigiCertClickID_VrqPJ2Cs", "10", "s", "white", "VrqPJ2Cs"]);(function(){var cid=document.createElement("script");cid.async=true;cid.src="//seal.digicert.com/seals/cascade/seal.min.js";var s = document.getElementsByTagName("script");var ls = s[(s.length - 1)];ls.parentNode.insertBefore(cid, ls.nextSibling);}());
                    </script>
			...
			<div class="row">
				...
				<div class="copyright"><?php //echo date("Y"); ?> &copy; Somrurals. <?php echo DERECHOS_RESERVADOS; ?>.</div>
 ...
 <!-- This is the start of the super important snippet -->
    <div class="ui-widget">
  		<div class="cookie-message ui-widget-header">
			Si continúas navegando es que aceptas nuestra <a href="cookies.php">Política de cookies</a>.
  		</div>
    </div>

<!-- Cookies  -->       
<script src="<?php echo CDN_BASE; ?>assets/js/jquery.cookieBar.min.js"></script>
...
<script type="text/javascript">
    ...
    <?php if(!empty(ENVIRONMENT) && ENVIRONMENT != 'production') echo $debugbarRenderer->render(); ?>

    <!-- Start of HubSpot Embed Code -->
    <script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/5441712.js"></script>
