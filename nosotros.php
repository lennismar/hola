...
$meta_title=QUIENES_SOMOS ." | SomRurals.com";
$meta_description=QUIENES_SOMOS_SEO_DESCRIPCION;
		...
		<div class="hero--small hero-custom-template">
			...
			<div class="hero-container">
				...
				<div class="hero-inner--small">
					...
					<h1 class="h1-header"><?php echo QUIENES_SOMOS;?></h1>
	...
	<section class="wrapper">
		...
		<div class="page-container-fixed-pad">
			...
			<article class="col-pad col-pad--two-third content-custom-template">
				<?php echo QUIENES_SOMOS_CONTENT;?>
			</article>
